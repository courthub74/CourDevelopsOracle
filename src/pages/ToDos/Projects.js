...
class ProjectsToDo extends React.Component {
    constructor(props) {
        super(props);
            ...
            //You must 'bind' each function
            this.fetchTasks = this.fetchTasks.bind(this) //Gives access to 'this' within 'fetchtasks'
            this.handleChange = this.handleChange.bind(this) //Same as above accept the function is now 'handleChange'
